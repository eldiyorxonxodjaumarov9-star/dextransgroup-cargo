...
const uz: Dictionary = {
  ...
  home: {
    ...
    heroLabel: "CHINA → UZBEKISTAN · LOGISTICS NETWORK",
    heroTitle: "Xitoydan Toshkentgacha.\nYukingiz nazorat ostida.",
    heroText:
      "Dextrans — Xitoy omborlari, yuk kuzatuvi va tezkor logistika uchun yagona boshqaruv tizimi.",
    ctaCargo: "Yukni tekshirish",
    ctaWarehouses: "Omborlarni ko‘rish",
    trackPlaceholder: "Trek raqamini kiriting",
    trackCta: "Tekshirish",
    networkKicker: "01 · Live network",
    networkTitle: "Global cargo corridor",
    processKicker: "02 · Why Dextrans",
    processTitle: "Aniq nazorat. Tez marshrut. Ishonch.",
    finalCtaTitle: "Yukingizni hozir kuzating",
    finalCtaText: "Trek raqami orqali holatni oching yoki omborlar bilan bog‘laning.",
...
const ru: Dictionary = {
  ...
  home: {
    ...
    heroLabel: "CHINA → UZBEKISTAN · LOGISTICS NETWORK",
    heroTitle: "Из Китая до Ташкента.\nГруз под контролем.",
    heroText:
      "Dextrans — единая система складов в Китае, отслеживания грузов и оперативной логистики.",
    ctaCargo: "Проверить груз",
    ctaWarehouses: "Смотреть склады",
    trackPlaceholder: "Введите трек-номер",
    trackCta: "Проверить",
    networkKicker: "01 · Live network",
    networkTitle: "Глобальный cargo-коридор",
    processKicker: "02 · Why Dextrans",
    processTitle: "Точный контроль. Быстрый маршрут. Доверие.",
    finalCtaTitle: "Отследите груз сейчас",
    finalCtaText: "Откройте статус по трек-номеру или свяжитесь со складами.",
...
const en: Dictionary = {
  ...
  home: {
    ...
    heroLabel: "CHINA → UZBEKISTAN · LOGISTICS NETWORK",
    heroTitle: "From China to Tashkent.\nYour cargo under control.",
    heroText:
      "Dextrans is a unified command system for China warehouses, cargo tracking and fast logistics.",
    ctaCargo: "Track cargo",
    ctaWarehouses: "View warehouses",
    trackPlaceholder: "Enter tracking number",
    trackCta: "Track",
    networkKicker: "01 · Live network",
    networkTitle: "Global cargo corridor",
    processKicker: "02 · Why Dextrans",
    processTitle: "Precise control. Fast routing. Trust.",
    finalCtaTitle: "Track your shipment now",
    finalCtaText: "Open status by tracking number or connect with warehouses.",
...
const zh: Dictionary = {
  ...
  home: {
    ...
    heroLabel: "CHINA → UZBEKISTAN · LOGISTICS NETWORK",
    heroTitle: "从中国到塔什干。\n货物全程可控。",
    heroText: "Dextrans 是中国仓库、货物跟踪与高效物流的统一指挥系统。",
    ctaCargo: "查询货物",
    ctaWarehouses: "查看仓库",
    trackPlaceholder: "输入运单号",
    trackCta: "查询",
    networkKicker: "01 · Live network",
    networkTitle: "全球货运走廊",
    processKicker: "02 · Why Dextrans",
    processTitle: "精准管控。快速路线。值得信赖。",
    finalCtaTitle: "立即追踪货物",
    finalCtaText: "通过运单号查看状态，或联系仓库。",
    delivered: "已交付货物",
    happyClients: "满意客户",
    support: "支持服务",
    quickMenu: "快捷菜单",
...
const kk: Dictionary = {
  ...
  home: {
    ...
    heroLabel: "CHINA → UZBEKISTAN · LOGISTICS NETWORK",
    heroTitle: "Қытайдан Ташкентке дейін.\nЖүгіңіз бақылауда.",
    heroText:
      "Dextrans — Қытай қоймалары, жүк қадағалау және жедел логистика үшін бірыңғай жүйе.",
    ctaCargo: "Жүкті тексеру",
    ctaWarehouses: "Қоймаларды көру",
    trackPlaceholder: "Трек нөмірін енгізіңіз",
    trackCta: "Тексеру",
    networkKicker: "01 · Live network",
    networkTitle: "Жаһандық cargo дәлізі",
    processKicker: "02 · Why Dextrans",
    processTitle: "Нақты бақылау. Жылдам маршрут. Сенім.",
    finalCtaTitle: "Жүкті қазір қадағалаңыз",
    finalCtaText: "Трек нөмірі бойынша мәртебені ашыңыз немесе қоймалармен байланысыңыз.",
