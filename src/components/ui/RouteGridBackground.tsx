...
export function RouteGridBackground({ className }: { className?: string }) {
  return (
    ...
    >
      <div className="route-grid absolute inset-0 opacity-[0.35] dark:opacity-[0.22]" />
      <svg
      ...
      >
        ...
        />
        <path
          className="route-line route-line-delay"
        ...
        <defs>
          <linearGradient id="routeGrad" x1="0" y1="0" x2="1" y2="0">
            ...
            <stop offset="1" stopColor="#087068" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
    </div>
