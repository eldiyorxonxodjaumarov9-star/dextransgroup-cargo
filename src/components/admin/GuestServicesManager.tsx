    ...
    <div className="space-y-6">
      <form onSubmit={onSubmit} className="card grid gap-4 rounded-[var(--radius-xl)] p-4 sm:p-5 md:grid-cols-2">
        <div className="md:col-span-2">
          <h2 className="font-display text-xl font-semibold tracking-tight">Yangi media qo‘shish</h2>
        ...
        <div className="field md:col-span-2">
          <label
            className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-[var(--radius-xl)] border border-dashed border-[var(--accent)]/50 bg-[color-mix(in_srgb,var(--accent)_18%,transparent)] px-4 py-8 text-center"
      ...
      <div className="space-y-3">
        <h2 className="font-display text-xl font-semibold tracking-tight">
          Yuklangan media ({media.length})
        </h2>
        {!media.length && (
          <div className="card rounded-[var(--radius-xl)] p-5 text-sm text-[var(--text-secondary)]">
        ...
        <div className="grid gap-3">
          {media.map((item) => (
            <div
              key={item.id}
              className="card flex flex-wrap items-center gap-4 rounded-[var(--radius-xl)] p-4"
            >
              <span className="flex h-11 w-11 items-center justify-center rounded-[var(--radius-md)] bg-[color-mix(in_srgb,var(--accent)_18%,transparent)] text-[var(--accent)]">
