    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
        <p className="text-sm text-[var(--text-secondary)]">
          {filtered.length} ta yozuv topildi
        </p>
        <button
          type="button"
          className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-[var(--radius-md)] bg-[var(--accent)] px-6 text-sm font-bold tracking-wide text-[var(--accent-foreground)] shadow-[0_0_28px_color-mix(in_srgb,var(--accent)_28%,transparent)] transition hover:brightness-110 sm:w-auto"
          onClick={exportExcel}
        >
